...
?>
	<div id="primary" class="content-area">
		...
		<?php if ( sonic_do_infinitescroll_trigger() ) : ?>
		...
		<?php
			...
			/**
			 * sonic_blog_pagination hook
			 *
			 * @see inc/frontend/hooks/site-page-hooks.php sonic_output_blog_pagination function
			 */
			do_action( 'sonic_blog_pagination' );
		?>
