...
<?php if ( has_post_thumbnail() ) : ?>
	<article <?php sonic_post_attr(); ?> <?php post_class( $classes ); ?> <?php sonic_article_schema(); ?>>
		<?php wolf_post_start(); ?>
				...
				<?php if ( ! post_password_required() ) : ?>
					<div class="post-grid3-entry-content">
						<div class="post-grid3-entry-caption">
							<?php if ( sonic_get_first_category() ) : ?>
								<span class="post-grid3-category"><?php echo sanitize_text_field( sonic_get_first_category() ); ?></span>
							<?php endif; ?>
