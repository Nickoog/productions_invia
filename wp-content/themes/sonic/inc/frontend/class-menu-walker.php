...
if ( ! class_exists( 'Sonic_Custom_Fields_Nav_Walker' ) ) {
	/**
	 * @since Sonic 1.0.0
	 */
	class Sonic_Custom_Fields_Nav_Walker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$mega_menu_bg = ( $img_id ) ? esc_url( wolf_get_url_from_attachment_id( absint( $img_id ), 'sonic-XL' ) ) : '';
