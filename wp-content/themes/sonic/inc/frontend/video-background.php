<?php
/**
 * Sonic video background function
 *
 * @package WordPress
 * @subpackage Sonic
 * @version 2.2.4
...
if ( ! function_exists( 'sonic_video_bg' ) ) {
	/**
	 ...
	 */
	function sonic_video_bg( $mp4 = null, $webm = null, $ogv = null, $img = null, $parallax = false ) {
...
if ( ! function_exists( 'sonic_youtube_video_bg' ) ) {
	/**
	 ...
	 */
	function sonic_youtube_video_bg( $url = null, $img_fallback = null, $parallax = false ) {
