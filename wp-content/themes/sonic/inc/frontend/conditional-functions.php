 ...
 * @return bool
 */
function sonic_is_home_as_blog() {
 ...
 * @return bool
 */
function sonic_is_blog_index() {

	global $wp_query;

	return sonic_is_home_as_blog() || ( is_object( $wp_query ) && isset( $wp_query->queried_object ) && isset( $wp_query->queried_object->ID ) && $wp_query->queried_object->ID == get_option( 'page_for_posts' ) );
}
 ...
 * @return bool
 */
function sonic_is_blog() {

	$is_blog = ( sonic_is_home_as_blog() || sonic_is_blog_index() || is_search() || is_archive() ) && ! sonic_is_woocommerce() && 'post' == get_post_type();
	return ( true == $is_blog );
}
 ...
 * @return bool
 */
function sonic_should_display_sidebar() {
	global $wp_customize;
	$is_customizer = ( isset( $wp_customize ) ) ? true : false;

	$is_right_post_type = ! is_singular( 'show' );
	$blog_layout = sonic_is_blog() && ( 'sidebar' == sonic_get_blog_layout() || 'sidebar-left' == sonic_get_blog_layout() || 'sidebar-right' == sonic_get_blog_layout() );
	$shop_layout = sonic_is_woocommerce() && ( 'sidebar-left' == wolf_get_theme_mod( 'shop_layout' ) || 'sidebar-right' == wolf_get_theme_mod( 'shop_layout' ) );
	$disco_layout = sonic_is_discography() && ( 'sidebar-left' == wolf_get_theme_mod( 'discography_layout' ) || 'sidebar-right' == wolf_get_theme_mod( 'discography_layout' ) );
	$videos_layout = sonic_is_videos() && ( 'sidebar-left' == wolf_get_theme_mod( 'videos_layout' ) || 'sidebar-right' == wolf_get_theme_mod( 'videos_layout' ) );
	$albums_layout = sonic_is_albums() && ( 'sidebar-left' == wolf_get_theme_mod( 'albums' ) || 'sidebar-right' == wolf_get_theme_mod( 'albums' ) );
	$portfolio_layout = sonic_is_portfolio() && ( 'sidebar-left' == wolf_get_theme_mod( 'portfolio' ) || 'sidebar-right' == wolf_get_theme_mod( 'portfolio' ) );
	$events_layout = sonic_is_events() && ( 'sidebar-left' == wolf_get_theme_mod( 'events' ) || 'sidebar-right' == wolf_get_theme_mod( 'events' ) );
 ...
 * @return bool
 */
function sonic_is_main_menu() {
	$is_centered = 'centered' == sonic_get_menu_layout() && has_nav_menu( 'primary-left' ) || has_nav_menu( 'primary-right' );
	$is_standard = 'centered' != sonic_get_menu_layout() && has_nav_menu( 'primary' );
 ...
 * @return bool
 */
function sonic_do_infinitescroll() {

	if ( ( sonic_is_blog() ) && wolf_get_theme_mod( 'blog_infinitescroll' ) ) {
		return true;
	} elseif ( ( sonic_is_portfolio() ) && wolf_get_theme_mod( 'portfolio_infinitescroll' ) ) {
		return true;
	}
}
 ...
 * @return bool
 */
function sonic_do_infinitescroll_trigger() {

	if ( ( sonic_is_blog() ) && wolf_get_theme_mod( 'blog_infinitescroll_trigger' ) ) {
		
		return true;
	
	} elseif ( ( sonic_is_portfolio() ) && wolf_get_theme_mod( 'portfolio_infinitescroll_trigger' ) ) {
 ...
 * @return bool
 */
function sonic_do_ajax_category_filter() {

	$display = array( 'metro', 'masonry', 'masonry2', 'photo', 'grid', 'grid2', 'grid3', 'column' );

	$return = null;

	if ( ( sonic_is_blog() ) && wolf_get_theme_mod( 'blog_category_filter' ) ) {
		
		$return = in_array( sonic_get_blog_display(), $display ); 
	
	} elseif ( ( sonic_is_portfolio() ) && wolf_get_theme_mod( 'portfolio_category_filter' ) ) {
		
		$return = in_array( sonic_get_portfolio_display(), $display );
	}
 ...
 * @return bool
 */
function sonic_do_ajax_nav() {

	return apply_filters( 'sonic_do_ajax_nav', wolf_get_theme_mod( 'ajax_nav' ) );
}
 ...
 * @return bool
 */
function sonic_is_seo_plugin_installed() {
