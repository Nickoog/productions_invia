<?php
/**
 * Sonic - print custom CSS in head tag
 *
 * @package WordPress
 * @subpackage Sonic
 * @version 2.2.4
 ...
 * @since Sonic 1.0.0
 */
function sonic_output_settings_options_css() {
	
	$css = '';

	if ( sonic_settings_css() ) {
		$css .= '/* sonic options */' . "\n";
		$css .= sonic_settings_css() . "\n";
	}
	wp_add_inline_style( 'sonic-style', $css );
}
add_action( 'wp_enqueue_scripts', 'sonic_output_settings_options_css', 11 );
 ...
 * @return  string
 */
function sonic_get_background_css( $selector, $option_name ) {
