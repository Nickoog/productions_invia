 ...
 */
function sonic_color_scheme_css() {
	$color_scheme_option = sonic_get_color_scheme_option();
	...
	$color_scheme_css = sonic_get_color_scheme_css( $colors );

	if ( ! SCRIPT_DEBUG ) {
		$color_scheme_css = wolf_compact_css( $color_scheme_css );
	}

	wp_add_inline_style( 'sonic-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'sonic_color_scheme_css' );
 ...
 * @see wp_add_inline_style()
 */
function sonic_background_color_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $background_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_page_background_color_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $page_background_color, $search_overlay_bg_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_page_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_accent_color_css() {
	$color_scheme = sonic_get_color_scheme();
	...
	$css = '
		...
		.wolfdotcom a.wolf_add_to_wishlist:hover,
		.gaia a.wolf_add_to_wishlist:hover,
		.wolfdotcom a.add_to_cart_button:hover,
		.gaia a.add_to_cart_button:hover,
		.wolfdotcom a.more-link:hover,
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $accent_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_accent_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_main_text_color_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $main_text_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_main_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_secondary_text_color_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $secondary_text_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_secondary_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_strong_text_color_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $strong_text_color, $border_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_strong_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_submenu_background_color_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $submenu_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_submenu_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_entry_content_background_color_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $entry_content_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_entry_content_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_product_tabs_css() {
	$color_scheme          = sonic_get_color_scheme();
	...
	wp_add_inline_style( 'sonic-style', sprintf( $css, $product_tabs_background_color, $product_tabs_text_color ) );
}
add_action( 'wp_enqueue_scripts', 'sonic_product_tabs_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function sonic_customizer_layout_css() {
	...
	$layout_css .= '
		.nav-menu li.hot > a .menu-item-text-container:before{
			content : "' . esc_html__( 'hot', 'sonic' ) . '";
		}

		.nav-menu li.new > a .menu-item-text-container:before{
			content : "' . esc_html__( 'new', 'sonic' ) . '";
		}
	';

	$site_width = apply_filters( 'sonic_site_width', wolf_get_theme_mod( 'site_width' ) );
	...
	$site_margin = apply_filters( 'sonic_site_margin', wolf_get_theme_mod( 'site_margin' ) );
	...
	/* Link style */
	$accent = apply_filters( 'sonic_accent_color', wolf_get_theme_mod( 'accent_color' ) );
	if ( $accent ) {
		$text_link_style = apply_filters( 'sonic_text_link_style', wolf_get_theme_mod( 'text_link_style', 'colored' ) );
	...
	if ( $menu_height ) {
		$menu_height_with_top_bar = ( sonic_display_topbar() ) ? 38 : 0;
	...
	if ( $background_404 ) {
		$background_404_img_url = esc_url( wolf_get_url_from_attachment_id( $background_404, 'sonic-XL' ) );
		$layout_css .= '
	...
	wp_add_inline_style( 'sonic-style', $layout_css );
}
add_action( 'wp_enqueue_scripts', 'sonic_customizer_layout_css' );
 ...
 * @see wp_add_inline_style()
 */
function sonic_customizer_fonts_css() {
	...
	wp_add_inline_style( 'sonic-style', $font_css );
}
add_action( 'wp_enqueue_scripts', 'sonic_customizer_fonts_css' );
 ...
 * @see wp_add_inline_style()
 */
function sonic_customizer_backgrounds_css() {
	...
	$backgrounds_css .= sonic_get_customizer_bg_css( $backgrounds );

	if ( ! SCRIPT_DEBUG ) {
		$backgrounds_css = wolf_compact_css( $backgrounds_css );
	}

	wp_add_inline_style( 'sonic-style', $backgrounds_css );
} // end function
add_action( 'wp_enqueue_scripts', 'sonic_customizer_backgrounds_css' );
