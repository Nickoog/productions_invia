...
function wolf_framework_enqueue_admin_scripts() {
	...
	wp_localize_script(
		'wolf-admin', 'WolfAdminParams', array(
			'chooseImage' => esc_html__( 'Choose an image', 'sonic' ),
			'chooseFile' => esc_html__( 'Choose a file', 'sonic' ),
			'noResult' => esc_html__( 'Oops, nothing found!', 'sonic' ),
			'resetModsText'   => esc_html__( 'Reset', 'sonic' ),
			'confirm' => esc_html__( 'Are you sure to want to reset all mods to default? There is no way back.', 'sonic' ),
			'nonce' => array(
