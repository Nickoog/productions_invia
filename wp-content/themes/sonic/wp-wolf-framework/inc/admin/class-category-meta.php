			...
			foreach ( $this->cat_meta as $field ) {
				...
				echo '</label>';
					...
					if ( 'text' == $type || 'int' == $type ) {
						...
						<br><a href="#" class="button wolf-settings-reset-bg"><?php esc_html_e( 'Clear', 'sonic' ); ?></a>
						<a href="#" class="button wolf-settings-set-bg"><?php esc_html_e( 'Choose an image', 'sonic' ); ?></a>
						<?php
						...
						<div>
							...
							<br><a href="#" class="button wolf-settings-reset-file"><?php esc_html_e( 'Clear', 'sonic' ); ?></a>
							<a href="#" class="button wolf-settings-set-file"><?php esc_html_e( 'Choose a file', 'sonic' ); ?></a>
							<br><br>
						</div>
						...
						<br><a href="#" class="button wolf-settings-reset-img"><?php esc_html_e( 'Clear', 'sonic' ); ?></a>
						<a href="#" class="button wolf-settings-set-img"><?php esc_html_e( 'Choose an image', 'sonic' ); ?></a>
						</div>
						<?php
