			...
			foreach ( $meta_fields as $field ) {
				...
				<td>";
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-file"><?php esc_html_e( 'Clear', 'sonic' ); ?></a>
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-img"><?php esc_html_e( 'Clear', 'sonic' ); ?></a>
					...
					-------------------------------------------*/
						...
						?>
						<p><?php esc_html_e( 'Background color', 'sonic' ); ?></p>
						...
						?>
						<p><?php esc_html_e( 'Background image', 'sonic' ); ?></p>
						<div>
						...
						?>
						<br>
						<p><?php esc_html_e( 'Background repeat', 'sonic' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background position', 'sonic' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background size', 'sonic' ); ?></p>
						...
						if ( $parallax ) {
							?>
							<br><br>
							<p><strong><?php esc_html_e( 'Parallax', 'sonic' ); ?></strong></p>
					...
					-------------------------------------------*/
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
						?>
						<p><?php esc_html_e( 'Font color', 'sonic' ); ?></p>
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font weight', 'sonic' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'For example: 400 is normal, 700 is bold.The available font weights depend on the font.<br>Leave empty to use the theme default style', 'sonic' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font transform', 'sonic' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style in the theme options', 'sonic' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font style', 'sonic' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style defined in the theme options', 'sonic' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font letter spacing (omit px)', 'sonic' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'Leave empty to use the style defined in the theme options', 'sonic' ); ?></span>
						<?php
						}
					...
					-------------------------------------------*/
						...
						?>
						<div>
							<p><strong><?php esc_html_e( 'mp4 URL', 'sonic' ); ?></strong></p>
							<input type="text"  name="<?php echo esc_attr( $field_id ); ?>_mp4" id="<?php echo esc_attr( $field_id ); ?>_mp4" value="<?php echo esc_url( $mp4 ); ?>">
							<br><a href="#" class="button wolf-options-reset-file"><?php esc_html_e( 'Clear', 'sonic' ); ?></a>
							<a href="#" class="button wolf-options-set-video-file"><?php esc_html_e( 'Choose a file', 'sonic' ); ?></a>
							<br><br>
						</div>

						<div>
							<p><strong><?php esc_html_e( 'webm URL', 'sonic' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'ogv URL', 'sonic' ); ?></strong></p>
						...
						<div>
						<p><strong><?php esc_html_e( 'Video Image Fallback', 'sonic' ); ?></strong></p>
						<input type="hidden"  name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo esc_attr( $img ); ?>">
