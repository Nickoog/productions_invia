...
if ( ! class_exists( 'Wolf_Admin_About_Page' ) ) {
	...
	class Wolf_Admin_About_Page {
		...
		public function admin_menus() {
			...
			add_theme_page( esc_html__( 'About the Theme', 'sonic' ), esc_html__( 'About the Theme', 'sonic' ), 'switch_themes', 'wolf-theme-about', array( $this, 'about_screen' ) );
		}
		...
		private function intro() {
			...
			?>
			<h1><?php printf( esc_html__( 'Welcome to %s %s', 'sonic' ), $theme_name, $theme_version ); ?></h1>

			<div class="about-text wolf-about-text">
				<?php
					if ( isset( $_GET['wolf-theme-updated'] ) ) {
						$message = esc_html__( 'Thank you for updating to the latest version!', 'sonic' );
					} else {
						$message = sprintf( esc_html__( 'Thanks for installing %s theme!', 'sonic' ), $theme_name );
					}

					if ( isset( $_GET['wolf-theme-activated'] ) ) {
						
						printf( esc_html__( '%s We hope you will enjoy using it.', 'sonic' ), $message );
					
					} elseif ( isset( $_GET['wolf-theme-updated'] ) ) {
						
						printf( wp_kses( __( '%s <br> %s is now more stable and secure than ever.<br>We hope you enjoy using it.', 'sonic' ), array( 'br' => array() ) ), $message, $theme_name );
					
					} else {
						printf( esc_html__( '%s We hope you enjoy using it.', 'sonic' ), $message );
					}
				?>
			</div>
			<div class="wp-badge wolf-about-page-logo">
			<?php printf( esc_html__( 'Version %s', 'sonic'  ), sanitize_text_field( $theme_version ) ); ?></div>
			<?php
		}
			...
			<div id="wolf-welcome-tabs">
				<h2 class="nav-tab-wrapper">
					<div class="tabs" id="tabs1">
						<a href="#welcome" class="nav-tab nav-tab-active"><?php esc_html_e( 'System Status', 'sonic' ); ?></a>
						<a href="#changelog" class="nav-tab"><?php esc_html_e( 'Changelog', 'sonic' ); ?></a>	
					</div>
				</h2>
				<div class="content">
		...
		public function system_status() {
			...
			<div id="wolf-system-status">
				...
				<p>
					<?php esc_html_e( 'Check that all the requirements below are fulfiled and labeled in green.', 'sonic' ); ?>
				</p>

				<h4><?php esc_html_e( 'WordPress Environment', 'sonic' ); ?></h4>
			...
			$theme_version_error_message = ( ! $theme_version_condition ) ? ' - ' . esc_html__( 'It is recommended to update the theme to the latest version', 'sonic' ) : '';
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'Theme Version', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php printf( __( 'The version of %s installed on your site.', 'sonic' ), WOLF_THEME_NAME ); ?>" href="<?php echo esc_url( $theme_update_url ); ?>"><span class="dashicons dashicons-editor-help"></span></a></td>
			...
			$wp_version_error_message = ( ! $wp_version_condition ) ? ' - ' . esc_html__( 'It is recommended to update WordPress to the latest version', 'sonic' ) : '';
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'WP Version', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php esc_html_e( 'The version of WordPress installed on your site.', 'sonic' ); ?>" href="https://docs.wolfthemes.com/document/keep-wordpress-installation-date/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a></td>
			...
			$wp_memory_limit_error_message = ( ! $wp_memory_limit_condition ) ? ' - ' . sprintf( __( 'It is recommended to increase your WP memory limit to %s at least', 'sonic' ), WOLF_REQUIRED_WP_MEMORY_LIMIT ) : '';
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'WP Memory Limit', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php esc_html_e( 'The maximum amount of memory (RAM) that your site can use at one time.', 'sonic' ); ?>" href="https://docs.wolfthemes.com/document/increasing-the-wordpress-memory-limit/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a></td>
				...
				<h4><?php esc_html_e( 'Server Environment', 'sonic' ); ?></h4>
			...
			$php_version_error_message = ( ! $php_version_condition ) ? ' - ' . sprintf( __( 'The theme needs at least PHP %s installed on your server', 'sonic' ), WOLF_REQUIRED_PHP_VERSION ) : '';
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'PHP Version', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php esc_html_e( 'The version of PHP installed on your hosting server.', 'sonic' ); ?>" href="https://docs.wolfthemes.com/document/how-to-update-your-php-version/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a></td>
			...
			$max_input_vars_condition_error_message = ( ! $max_input_vars_condition ) ? ' - ' . sprintf( __( 'It is recommended to increase your server max_input_var value to %s at least', 'sonic' ), WOLF_REQUIRED_MAX_INPUT_VARS ) : '';
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'PHP Max Input Vars', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php esc_html_e( 'The maximum amount of variable your server can use for a single function.', 'sonic' ); ?>" href="https://docs.wolfthemes.com/document/increasing-the-php-max-input-vars/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a></td>
			...
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'PHP Post Max Size', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php esc_html_e( 'The largest filesize that can be contained in one post.', 'sonic' ); ?>" href="https://docs.wolfthemes.com/document/increase-upload-size-limit/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a></td>
			...
			$php_memory_limit_error_message = ( ! $php_memory_limit_condition ) ? ' - ' . sprintf( __( 'It is recommended to increase your server memory limit to %s at least', 'sonic' ), WOLF_REQUIRED_SERVER_MEMORY_LIMIT ) : '';
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'Server Memory Limit', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php esc_html_e( 'The maximum amount of memory (RAM) that your server can use at one time.', 'sonic' ); ?>" href="https://docs.wolfthemes.com/document/increasing-server-memory-limit/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a></td>
			...
			?>
					<tr>
						<td class="label"><?php esc_html_e( 'Max Upload Size', 'sonic' ); ?></td>
						<td class="help"><a class="hastip" title="<?php esc_html_e( 'The largest filesize that can be uploaded to your WordPress installation.', 'sonic' ); ?>" href="https://docs.wolfthemes.com/document/increase-upload-size-limit/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a></td>
				...
				<p><?php
					printf( __( 'Please check the <a target="_blank" href="%s">server requirements</a> recommended by WordPress. You can find more informations <a href="%s" target="_blank">here</a>.', 'sonic' ),
