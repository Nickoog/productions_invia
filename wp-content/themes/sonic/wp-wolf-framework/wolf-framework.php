...
final class Wolf_Framework {
	...
	/**
	 * @var Phaedra The single instance of the class
	 */
	...
	/**
	 * Main Phaedra Instance
	 *
	 * Ensures only one instance of Phaedra is loaded or can be loaded.
	 *
	 * NOT USED YET
	 *
	 * @static
	 * @see WLFRMK()
	 * @return Phaedra - Main instance
	 */
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'sonic' ), $this->version );
	}
	...
	public function setup() {
		 ...
		 * If you're building a theme based on phaedra, use a find and replace
		 * to change 'sonic' to the name of your theme in all the template files
		 */
