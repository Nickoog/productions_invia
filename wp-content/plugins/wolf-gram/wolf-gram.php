 ...
 * Description: WolfGram is a plugin that uses the Instagram API to display your Instagram Feed
 * Version: 1.5.1
 * Author: WolfThemes
...
if ( ! class_exists( 'Wolf_Instagram' ) ) {
	...
	class Wolf_Instagram{
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'wolf-gram' ), '1.0' );
		}
		...
		private function define_constants() {
			...
			$constants = array(
				...
				'WG_DOC_URI' => 'http://docs.wolfthemes.com/documentation/plugins/' . plugin_basename( dirname( __FILE__ ) ),
		...
		public function includes() {
			...
			if ( $this->is_request( 'frontend' ) ) {
				include_once( 'inc/frontend/wg-functions.php' );
