...
class WPM_Admin {
	...
	public function admin_scripts() {
		...
		// Styles
		wp_enqueue_style( 'wpm-admin', WPM_CSS . '/admin/wpm-admin.css', array(), WPM_VERSION );
		
		// Scripts
		wp_enqueue_script( 'wp-media' );
		wp_enqueue_script( 'wpm-admin', WPM_JS . '/admin/admin.js', array( 'jquery', 'jquery-ui-sortable' ), WPM_VERSION, true );
