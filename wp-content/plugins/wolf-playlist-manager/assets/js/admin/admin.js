 ...
 */
 /* jshint -W062 */
var WPMAdmin = WPMAdmin || {},
	WPMAdminParams =  WPMAdminParams || {},
	console = console || {},
...
WPMAdmin = function ( $ ) {
	...
	return {
		...
		setTrackArtwork : function () {
		 	...
		 	$( '#wpm_tracklist' ).on( 'click', '.wpm-track-artwork', function() {
				...
				.on( 'select', function(){
					...
					currentArtworkId = parseInt( $( 'input', $el ).val() );
		...
		updateMeta : function( meta ) {
			...
			$( '#wpm_tracklist' ).on( 'keyup', '.wpm-track-' + meta, function() {
