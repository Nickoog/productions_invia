...
class WV_Options {
	...
	public function register_settings() {
		...
		add_settings_field( 'isotope', esc_html__( 'Use Isotope filter', 'wolf-videos' ), array( $this, 'setting_isotope' ), 'wolf-videos-settings', 'wolf-videos-settings', array( 'class' => 'wolf-videos-settings-columns' ) );
	}
