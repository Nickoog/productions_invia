...
$labels = array(
	...
	'singular_name' => esc_html__( 'Videos Type', 'wolf-videos' ),
	...
	'parent_item' => esc_html__( 'Parent Videos Type', 'wolf-videos' ),
	'parent_item_colon' => esc_html__( 'Parent Videos Type:', 'wolf-videos' ),
	'edit_item' => esc_html__( 'Edit Videos Type', 'wolf-videos' ),
	'update_item' => esc_html__( 'Update Videos Type', 'wolf-videos' ),
	'add_new_item' => esc_html__( 'Add New Videos Type', 'wolf-videos' ),
	'new_item_name' => esc_html__( 'New Videos Type', 'wolf-videos' ),
