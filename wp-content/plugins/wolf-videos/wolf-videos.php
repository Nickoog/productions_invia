 ...
 * Plugin URI: https://wolfthemes.com/plugin/wolf-videos/
...
class Wolf_Videos {
	...
	/**
	 * @var Wolf Videos The single instance of the class
	 */
	...
	/**
	 * Main Wolf Videos Instance
	 *
	 * Ensures only one instance of Wolf Videos is loaded or can be loaded.
	 *
	 * @static
	 * @see WE()
	 * @return Wolf Videos - Main instance
	 */
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'wolf-videos' ), '1.0' );
	}
	...
	/**
	 * Function used to Init Wolf Videos Template Functions - This makes them pluggable by plugins and themes.
	 */
	...
	/**
	 * Init Wolf Videos when WordPress Initialises.
	 */
	public function init() {
		...
		// Variables
		$this->template_url = apply_filters( 'wolf_videos_url', 'wolf-videos/' );
