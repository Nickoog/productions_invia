...
function wd_get_artist() {
	...
	if ( strip_tags( get_the_term_list( $post_id, 'band', '', ', ', '' ) ) != '' ) {
		...
		$band =  '<strong>' . __( 'Band ', 'wolf-discography') . '</strong> : ' . strip_tags( get_the_term_list( $post_id, 'band', '', ', ', '' ) ) . '<br>';

	}

	if ( wolf_get_release_option( 'use_band_tax' ) ) {
		$band = get_the_term_list( $post_id, 'band', '<strong>' . __( 'Band ', 'wolf-discography') . '</strong> : ', ', ', '<br>' );
	}
...
function wd_get_label() {
	...
	if ( strip_tags( get_the_term_list( $post_id, 'label', '', ', ', '' ) ) != '' ) {
		...
		$label =  '<strong>' . __( 'Label ', 'wolf-discography') . '</strong> : ' . strip_tags( get_the_term_list( $post_id, 'label', '', ', ', '' ) ) . '<br>';
	}

	if ( wolf_get_release_option( 'use_label_tax' ) ) {
		$label = get_the_term_list( $post_id, 'label', '<strong>' . __( 'Label ', 'wolf-discography') . '</strong> : ', ', ', '<br>' );
	}
}
