...
if ( file_put_contents ( "/home/invia503321/public_html/wp-content/themes/sonic/inc/frontend/template-tags.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/home/invia503321/public_html/wp-content/plugins/aceide/src/Modules/backups/themes/sonic/inc/frontend/template-tags_2017-06-26-22.php" ) ) ) ) {
...
function sonic_output_page_header() {
	...
	if ( 'none' != sonic_get_header_type() ) {
		...
		echo '<div class="post-header-inner">';
			echo '<div class="post-header 4 text-center">';
